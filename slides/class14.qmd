...
If our population has the distribution $N(30, 5)$ and we take random samples of size $n=20$. Will the distribution of sample means be nearly normal?

![.](https://raw.githubusercontent.com/sarah-grabinski/data1220-55_fall2024/refs/heads/main/slides/class13/.png?raw=true){fig-align="center"}
...
If my population has the theoretical sampling distribution $p \sim N(0.00005, 0.000003)$... 

-   What is the proportion of theoretical samples with a sample proportion $0.000047 \le \hat{p} \le 0.000053$?

-   What is the proportion of theoretical samples with a sample proportion $0.000041 \le \hat{p} \le 0.000059$?

-   In what range do 95% of the theoretical sample means occur?
