...
:::
::: column
![Pam's SAT score and Jim's ACT score on a standardized scale, with center = 0 and 1 unit = 1 standard deviation.](https://raw.githubusercontent.com/sarah-grabinski/data1220-55_fall2024/refs/heads/main/slides/class12/shaded-above.png?raw=true){fig-align="center"}
:::
:::

## Probabilities 

-   The *complement* of the percentile

-   Area under a probability curve = 1 (i.e. ***sample space***)

-   Area *above* a percentile = 1 - area *below* a percentile
