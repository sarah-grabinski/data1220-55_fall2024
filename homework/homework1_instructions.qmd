...
Below are details on Homework 1, covering the introduction to R and RStudio and Chapter 1 of [OpenIntro Statistics](https://www.openintro.org/book/os/). This homework is due by 6:00pm on Friday, 9/6/24. No credit will be lost for assignments received by 7:00pm to account for issues with uploading. 10% of the points will be deducted from assignments received by 9:00am on Saturday, 9/7/24. Assignments turned in after this point are only eligible for 50% credit, so it benefits you to turn in whatever you have completed by the due date.
